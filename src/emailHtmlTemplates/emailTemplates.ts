...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_text_2 .v-container-padding-padding { padding: 5px 10px 10px !important; } #u_content_heading_2 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_text_deprecated_1 .v-container-padding-padding { padding: 40px 10px 10px !important; } }
    </style>
...
<table id="u_content_text_deprecated_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
    <div>
<div>This OTP is valid for the next 30 minutes. Please do not share it with anyone. If you did not request this, please ignore this email.</div>
</div>
  </div>
...
<table id="u_content_text_deprecated_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
    <div>
<div>Please do not share it with anyone. If you did not request this, please ignore this email.</div>
</div>
  </div>
...
export default function getHtmlTemplateForEmail({ type, otp, forgotPasswordUrl } : {
    type: string;
    otp?: number;
    forgotPasswordUrl?: string;
}) {
    if (type === 'OTP' && otp) {
        return htmlTemplates.OTP(otp);
    } else if (type === 'RESET' && forgotPasswordUrl) {
        return htmlTemplates.RESET(forgotPasswordUrl);
    } else if (type === 'PASSWORD_CHANGED') {
      return htmlTemplates.PASSWORD_CHANGED;
    }
